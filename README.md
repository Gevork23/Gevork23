...
Люблю писать чистый, читаемый и понятный код, придерживаюсь стандартов PEP 8, принципов DRY / KISS / SOLID  
и активно развиваюсь в области backend-разработки.
...
- Django ORM: фильтрация, оптимизация (select_related, prefetch_related)  

### 🧠 Backend-разработка
- REST API (CRUD, JWT-аутентификация, права доступа, пагинация, фильтрация)  
- Django Admin, формы и шаблоны (Bootstrap 5)  
- Интеграция внешних API (REST, JSON, OAuth)  
- Работа с файлами и изображениями (FileField, ImageField, Base64)  
- Тестирование и отладка (Pytest, Debug Toolbar, pdb)  
...
- Блог-платформа с авторизацией, CRUD и админкой  
- Настроены формы, шаблоны, фильтрация и пагинация  
- Использованы CBV (Class-Based Views)

---

### 🤖 [Telegram-бот “Практикум-бот”](#)
Стек: Python, PyTelegramBotAPI, Requests, Logging  
- Получает уведомления о проверке заданий на Яндекс Практикуме  
- Работает с API, логирует и отправляет сообщения  
- Деплой на PythonAnywhere (постоянная работа бота)
...
### 📔 Курсы
- ✍️ Интернет-маркетинг (2024)  
- ✍️ Администрирование ОС Linux (2023)  
- ✍️ Безопасность персональных данных в ИС (2024)
...
- Интеграция внешних API и работа с токенами  
- Понимание HTTP/HTTPS, REST, OAuth 2.0  
- Работа с англоязычной техдокументацией  
...
⭐️ *Этот профиль отражает мой путь в разработке — от основ Python до создания полноценных backend-приложений на Django и DRF.*  
...
<div align="left">
  ...
  <img src="https://luxe-host.ru/wp-content/uploads/3/1/6/316df50bcf36dccbe19dd219abf85b16.png" title="CSS" alt="CSS" width="40" height="40"/>&nbsp;
</div>
...
🎥 [Видео-анимация](https://user-images.githubusercontent.com/81191782/233836534-ffb5d7ea-00f0-436a-8d8c-73cfb3f8dcf6.mov)  
🔗 [Оригинал на Я.Диск](https://disk.yandex.ru/i/DvcfRkI_k6E0FQ)  

![Forrest_preview](https://user-images.githubusercontent.com/81191782/233836217-2417ba7a-5a1d-494c-884a-3264875ce1a6.png)  
🔗 [Оригинал на Я.Диск](https://disk.yandex.ru/d/535YB9X8C2PH4Q)
...
🎬 [Видео](https://user-images.githubusercontent.com/81191782/229910599-05de0125-dbf5-40aa-968c-80a5dfe1f78c.mov)  
🔗 [Оригинал на Я.Диск](https://disk.yandex.ru/i/oFl1Xe2lqB4YXQ)
...
<table>
  <tr>
    <td>
      <img align="left" src="http://github-readme-streak-stats.herokuapp.com?user=Gevork23&theme=dark&background=000000" alt="GitHub streak"/>
    </td>
    <td>
      <img height="195px" align="right" alt="Top langs" src="https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=Gevork23&layout=compact&theme=vision-friendly-dark"/>
    </td>
  </tr>
</table>
