🇷🇺 Русский | en [English](README_EN.md)
...
**Результат:** Автоматизированная система массовых уведомлений.

---

### 🍽 [DineTogether](https://github.com/Gevork23/DineTogether) — REST API для бронирования столов (Название изменено)
...
### 🍳 [Foodgram](https://github.com/Gevork23/foodgram) — Платформа для обмена рецептами

**Стек:** Django, Django REST Framework, PostgreSQL, Docker, Nginx, Gunicorn, JWT

- Разработал бэкенд для платформы обмена рецептами с подписками и корзиной покупок
...
### Backend-разработчик
**МФЦ Мясниковского района (МАУ)** | 10.2024 — настоящее время
